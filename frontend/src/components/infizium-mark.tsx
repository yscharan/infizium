export function InfiziumMark({ size = 28, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <rect x="28"   y="15.5" width="24" height="1.5" fill="#09090b" opacity="0.9" />
      <rect x="29.5" y="11.5" width="21" height="1.5" fill="#09090b" opacity="0.9" />
      ...
      <rect x="11" y="30.5" width="58" height="1.5" fill="#09090b" opacity="0.9" />
      <rect x="16" y="28"   width="48" height="1.5" fill="#09090b" opacity="0.9" />
      ...
      <rect x="37.5" y="66" width="5" height="4.5" fill="#09090b" opacity="0.9" />
